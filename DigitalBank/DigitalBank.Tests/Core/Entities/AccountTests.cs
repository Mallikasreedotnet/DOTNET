namespace DigitalBank.Tests.Core.Entities
{
    ...
    {
        [TestMethod]
        public void Account_VaildOpeningBalance_ShouldSuccees()
        {
        ...
        //Negative Test Case
        //[TestMethod]
        //public void Account_InvailOpeningBalance_ShouldThrowError()
        //{
        //    //Arrange
        //    var owner = new Owner("Avishek", "Kumar");
        //    var openingBalance = new Amount { Value = 300, Currency = CurrencyType.INR };
        //    //Act & Assert
        //    Assert.ThrowsException<ArgumentException>(() => new Account(owner, openingBalance));
        //}
        ////Positive Tet Case
        //[TestMethod]
        //public void Deposit_VaildAmount_ShouldSucceed()
        //{
        //    //Arrange
        ...
        //    var account=new Account(new Owner("Avishek","Kumar"),new Amount { Value=500, Currency=CurrencyType.INR });
        //    //Act & Assert
        //    Assert.ThrowsException<ArgumentOutOfRangeException>(() => account.Deposite(new Amount { Value = (decimal)depositAmount, Currency = CurrencyType.INR }, DateTime.Now, "Deposit vaild amount."));
        //}
    }
}
